...
const CardList: React.VFC = () => {
    ...
    if (isLoading && !data)
        return (
            <div className="card-list__message">
                <Spinner />
            </div>
        );
    ...
    return (
        <div className="wrapper card-list" id="list">
            <h3 className="card-list__header">
                Results for: <span className="card-list__header_query">{query}</span>
            </h3>
            <h3 className="card-list__sub-header">
                Total found: <span className="card-list__sub-header_total">{data.photos.total}</span>
            </h3>
